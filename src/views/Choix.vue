<template>
    ...
    <p>
        <small>Votre fréquentation de notre espace de coorking implique le respect <a
                href="https://www.coworking-metz.fr/reglement-interieur/">de notre règlement intérieur</a>. En cas de
