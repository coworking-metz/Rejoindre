<template>
    ...
    <form @submit.prevent="submitForm">
        <label>
            Mot de passe
            <input type="password" v-model="data.password" minlength="8" placeholder="Mot de passe" aria-label="Password"
                required />
        </label>
        <label>
            Vérification du mot de passe
            <input ref="verification" type="password" minlength="8" v-model="data.verification"
